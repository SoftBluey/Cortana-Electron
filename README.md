...
*   **Voice Search:** Click the microphone button in the search bar to speak. Your words appear with a shuffle text animation and auto-submit when you stop talking. Uses native Windows speech recognition for fast, accurate, offline transcription.
